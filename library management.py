...
def add_book():
    ...
    title = row_input('Enter Book Title :')
    author = row_input('Enter Book Author : ')
    publisher = row_input('Enter Book Publisher : ')
    pages = row_input('Enter Book Pages : ')
    price = row_input('Enter Book Price : ')
    edition = row_input('Enter Book Edition : ')
    copies = int(row_input('Enter copies : '))
...
def add_member():
    ...
    name = row_input('Enter Member Name :')
    clas = row_input('Enter Member Class & Section : ')
    address = row_input('Enter Member Address : ')
    phone = row_input('Enter Member Phone  : ')
    email = row_input('Enter Member Email  : ')
...
def modify_book():
    ...
    print('\n6. Book Edition')
    print('\n\n')
    choice = int(row_input('Enter your choice :'))
    field = ''
    if choice == 1:
        field = 'title'
    if choice == 2:
    ...
    if choice == 5:
        field = 'price'
    book_id = row_input('Enter Book ID :')
    value = row_input('Enter new value :')
...
def modify_member():
    ...
    if choice == 5:
        field = 'email'
    mem_id = row_input('Enter member ID :')
